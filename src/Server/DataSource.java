...
public class DataSource {
    ...
    private static final String EDIT_ASSET = "UPDATE assets set amount = ? where Orgunit = ? AND assetName = ? and AssetType IS NULL;";
    ...
    public void EditAsset(Asset asset1, Integer newQTY) {
        //UPDATE assets set amount = ? where Orgunit = ? AND assetName = ? and AssetType IS NULL
        try {
            EDITASSET.setInt(1, newQTY);
            EDITASSET.setString(2, asset1.GetOUID());
            EDITASSET.setString(3, asset1.GetName());
